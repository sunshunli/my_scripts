...
const inviteCodes = [
  `cgxZbCXTeuaPownODQ2s7UiLNn0Z2O9RTzsL6F4hIkNr05w1qAJ_@cgxZfCvKJbPS7wjIREnK6J_RPV7FYnKxDC-z@cgxZdTXtILvZvw6cXAKv6KLDjL6DbMznArPDWV1lU5Rs1tD_Xk0dfHUqR_g@cgxZdTXtI-_T61jIDFGhu_KWcwkIAHVkJj1B4qMY9hXLApY-_tjTxkmmMTw`,
  `cgxZbCXTeuaPownODQ2s7UiLNn0Z2O9RTzsL6F4hIkNr05w1qAJ_@cgxZfCvKJbPS7wjIREnK6J_RPV7FYnKxDC-z@cgxZdTXtILvZvw6cXAKv6KLDjL6DbMznArPDWV1lU5Rs1tD_Xk0dfHUqR_g@cgxZdTXtI-_T61jIDFGhu_KWcwkIAHVkJj1B4qMY9hXLApY-_tjTxkmmMTw`,
  `cgxZbCXTeuaPownODQ2s7UiLNn0Z2O9RTzsL6F4hIkNr05w1qAJ_@cgxZfCvKJbPS7wjIREnK6J_RPV7FYnKxDC-z@cgxZdTXtILvZvw6cXAKv6KLDjL6DbMznArPDWV1lU5Rs1tD_Xk0dfHUqR_g@cgxZdTXtI-_T61jIDFGhu_KWcwkIAHVkJj1B4qMY9hXLApY-_tjTxkmmMTw`,
  `cgxZbCXTeuaPownODQ2s7UiLNn0Z2O9RTzsL6F4hIkNr05w1qAJ_@cgxZfCvKJbPS7wjIREnK6J_RPV7FYnKxDC-z@cgxZdTXtILvZvw6cXAKv6KLDjL6DbMznArPDWV1lU5Rs1tD_Xk0dfHUqR_g@cgxZdTXtI-_T61jIDFGhu_KWcwkIAHVkJj1B4qMY9hXLApY-_tjTxkmmMTw`
]
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0) {
              if (data.data && data.data.bizCode === 0) {
                if (data.data.result.score) console.log(`任务完成，获得${data.data.result.score}爆竹🧨`)
      ...
      try {
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0) {
              if (data.data && data.data.bizCode === 0) {
                if (data.data.result.score) console.log(`任务完成，获得${data.data.result.score}积分`)
                else if (data.data.result.maxAssistTimes) {
                  console.log(`助力好友成功`)
                } else {
                  console.log(`任务上报成功`)
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0 && data.data && data.data.result) {
              ...
              if (result.awardType === 4) console.log(`抽奖成功，获得${result.score}爆竹🧨`)
              else if (result.awardType === 2 || result.awardType === 3) console.log(`抽奖成功，获得优惠卷`)
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0 && data.data && data.data.bizCode === 0) {
              ...
              if (info.dayAward) console.log(`白天关卡：${info.dayAward}元红包，完成进度 ${info.dayTotalValue}/${info.dayTargetSell}`)
              else {
...
function shareCodesFormatPk() {
  return new Promise(async (resolve) => {
    ...
    if (new Date().getUTCHours() >= 12) readShareCodeRes = await readShareCodePk()
    if (readShareCodeRes && readShareCodeRes.code === 200) {
