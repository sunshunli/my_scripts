...
// const inviteCodes = [`-4msulYas0O2JsRhE-2TA5XZmBQ@eU9Yar_mb_9z92_WmXNG0w@eU9YaO7jMvwh-W_VzyUX0Q`, `-4msulYas0O2JsRhE-2TA5XZmBQ@eU9Yar_mb_9z92_WmXNG0w@eU9YaO7jMvwh-W_VzyUX0Q`]
const inviteCodes = [`IRs1beyzZ_g`]
if ($.isNode()) {
...
function getAuthorShareCode() {
  return new Promise((resolve) => {
    $.get(
      {
        url: 'https://gitee.com/shylocks/updateTeam/raw/main/jd_cash.json',
        headers: {
